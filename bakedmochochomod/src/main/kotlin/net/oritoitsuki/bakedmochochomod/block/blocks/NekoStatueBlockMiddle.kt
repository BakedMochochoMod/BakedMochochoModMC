...
class NekoStatueBlockMiddle :
    ...
    override fun createBlockEntity(pos: BlockPos, state: BlockState): BlockEntity {
        return NekoStatueBlockMiddleEntity(pos, state)
    }
    ...
    override fun <T : BlockEntity?> getTicker(
        ...
        return checkType(type, ModBlockEntities.NEKO_STATUE_BLOCK_MIDDLE, NekoStatueBlockMiddleEntity::tick)
    }
}
